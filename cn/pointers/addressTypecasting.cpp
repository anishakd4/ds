...
Because int in int * will tell us how to read the 4 bytes availble as float also requires 4 bytes and also how many byes 
we need to read.
Thats why even if all pointers store just addresses we still need to mention type.
